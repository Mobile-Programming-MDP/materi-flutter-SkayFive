...
import 'package:cepuapp/models/post.dart';
...
class _AddPostScreenState extends State<AddPostScreen> {
    ...
    try {
      ...
      if (!serviceEnabled) {
        ScaffoldMessenger.of(
          context,
        ).showSnackBar(SnackBar(content: Text('Layanan lokasi dinonaktifkan')));
        return;
      }
  ...
  // 3. Fungsi tampil pilihan kategory
  ...
  Future<void> _submitPost() async {
    ...
    if (_category == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('Masukan deskripsi terlebih dahulu')),
      );
      return;
    }
    setState(() {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              _category ?? 'Belum Memilih Category',
              textAlign: TextAlign.center,
            ...
            TextField(
              ...
              decoration: const InputDecoration(
                labelText: 'Deskripsi',
                hintText: 'Masukan deskripsi laporan',
